      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="text-left">
          <div className="flex items-center gap-2 mb-4">
            ...
            />
            <span className="text-lg font-semibold">Bless Kontraktor</span>
          </div>
...
<div className="text-right">
  ...
  <div className="rounded-lg overflow-hidden border border-yellow-600 shadow-sm inline-block w-full max-w-[300px]">
    <iframe
      ...
      width="100%"
      height={150} // diperkecil dari 180px
      style={{ border: 0 }}
      allowFullScreen
      loading="lazy"
    ...
    />
      ...
      <div className="border-t border-yellow-700 py-4 text-sm text-yellow-500 flex flex-col md:flex-row justify-between items-center px-6 max-w-7xl mx-auto">
        <p>© {new Date().getFullYear()} Bless Kontraktor. All rights reserved.</p>
        <div className="flex gap-4 mt-2 md:mt-0">
          <p>Designed By <Link href="https://themonarchtech.com" className="text-white">
            TheMonarchTech
          </Link></p>
