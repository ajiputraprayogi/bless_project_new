...
export default function ProfilePage() {
  ...
  if (loading) return <p className="text-center text-gray-300 py-20">Loading...</p>;
        ...
        <div className="flex justify-center gap-4 mb-8 relative">
          ...
          <div className="group relative">
            <button
              ...
              onClick={() => setActiveTab((prev) => (prev === "visi" ? null : "visi"))}
            >
              Visi
            </button>
            <div
            ...
            >
              <p className="text-yellow-300 leading-relaxed">{companyData?.visi}</p>
            </div>
          </div>
          ...
          <div className="group relative">
            <button
              className="px-6 py-2 rounded-full font-semibold bg-zinc-800 text-gray-300 transition"
              onClick={() => setActiveTab((prev) => (prev === "misi" ? null : "misi"))}
            >
              Misi
            </button>
            <div
